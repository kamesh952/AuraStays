...
const StyledDrawer = styled(Drawer)(({ theme }) => ({
  ...
  '& .MuiDrawer-paper': {
    ...
    paddingTop: theme.spacing(8), // Added padding at the top
  },
}));
...
const DrawerHeader = styled('div')(({ theme }) => ({
  ...
  height: '64px !important', // Ensure consistent height
}));
      ...
      <Drawer
        ...
        sx={{
          ...
          '& .MuiDrawer-paper': {
            ...
            background: theme.palette.background.paper,
            boxShadow: theme.shadows[3],
            paddingTop: theme.spacing(8), // Added padding at the top for mobile
          },
        }}
      >
        {drawerContent}
